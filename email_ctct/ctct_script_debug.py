...
from reusable.maintenance import set_timestamp
...
class MyAPI:
    ...
    def get_campaign_all(self):
        url = "https://api.cc.email/v3/emails?limit=20"
        payload = {}
        headers = {
            'Authorization': 'Bearer QoWD5FzZ3O6EApLlTGMlrOx8XgTZ'
        }
